      ...
      <div className='flex justify-center items-center h-screen bg-black overflow-x-hidden relative'>
        ...
        <div className="text-container flex justify-center items-center">
          <div className="home-heading flex justify-center items-center flex-col w-[90%] text-center md:text-xl lg:text-2xl">
            <h1 className=' uppercase font-bold'><span className='text-primary'>From Vision to Convert</span> <span className='text-white'>Reality</span></h1>
            <h4 className='w-[70%] md:w-[60%] text-white'>Both web and app development involve designing, building, and maintaining software applications, but they have different characteristics and use cases.</h4>
