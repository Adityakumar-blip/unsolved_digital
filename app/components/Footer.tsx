    ...
    <div>
      <div className="w-full p-3  text-white bg-black font-bold p-[4rem] ">
        <div className="footer-main max-sm:text-center sm:text-center md:text-start">
          ...
          <p className="italic w-[35%] mt-1.5 text-white font-light max-sm:text-center sm:text-center md:text-start w-full">
        ...
        <div className="footer-sub flex-wrap gap-3 items-center">
          <h6 className="text-white max-sm:w-full sm:w-full md:w-auto text-center">
            Unsolved.agency@gmail.com
          </h6>
